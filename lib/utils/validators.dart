...
class Validator {
  ...
  static var facebookValidate = MultiValidator([
    RequiredValidator(errorText: "Please enter facebook Url."),
  ]);
  static var urlValidate = MultiValidator([
    RequiredValidator(errorText: "Please enter  Url."),
  ]);
 static var socialValidate = MultiValidator([
    RequiredValidator(errorText: "Please enter Social Media Channel."),
  ]);
  ...
  static var identify = MultiValidator([
    RequiredValidator(errorText: "Please enter Identification."),
  ]);
